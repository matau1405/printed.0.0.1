...
export class ExpeditionComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.expeditionService
      ...
      .subscribe((res: HttpResponse<IExpedition[]>) => this.paginateExpeditions(res.body, res.headers));
  }
  ...
  protected paginateExpeditions(data: IExpedition[], headers: HttpHeaders) {
