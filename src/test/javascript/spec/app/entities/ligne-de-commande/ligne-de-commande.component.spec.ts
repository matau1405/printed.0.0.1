...
import { LigneDeCommandeComponent } from 'app/entities/ligne-de-commande/ligne-de-commande.component';
...
describe('Component Tests', () => {
  describe('LigneDeCommande Management Component', () => {
    let comp: LigneDeCommandeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LigneDeCommandeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.ligneDeCommandes[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
